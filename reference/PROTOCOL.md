...
Original file came from [PROTOCOL.md](https://github.com/matu6968/libre-gxdl/blob/main/PROTOCOL.md) with existing paths preserved but not present in the C rewrite, see the [original project](https://github.com/matu6968/libre-gxdl) for other referenced files.
